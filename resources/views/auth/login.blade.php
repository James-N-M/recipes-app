...
<div class="w-1/2 m-auto h-64 flex justify-center items-center" style="height:20rem">
    <form class="bg-white mb-4 pb-8 pt-6 px-8 rounded shadow-md " method="POST" action="{{ route('login') }}">
        @csrf
        <div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <div class="">
                    <input class="appearance-none border focus:outline-none focus:shadow-outline focus:border-blue-lightest leading-tight px-3 py-2 rounded shadow text-grey-dark w-full" id="password" type="password" class="" name="password" required>
                </div>
            </div>

            <div>
                <div class="">
                    <button class="shadow bg-blue-light focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded">Sign In</button>
                </div>
            </div>
        </div>
    </form>
