...
@section('content')
<div class="">
    <div class="w-1/2 m-auto flex justify-center items-center mt-20">
        <form class="bg-white border-blue-light border-t-8 mb-4 pb-8 pt-6 px-8 rounded shadow-md w-1/2" method="POST" action="{{ route('login') }}">
            @csrf
            <div class="mb-4">
